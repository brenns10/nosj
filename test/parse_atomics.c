...
void test_parse_atomics(void)
{
	...
	smb_ut_test *parse_false =
	        su_create_test("parse_false", test_parse_false);
	...
	smb_ut_test *parse_empty_string =
	        su_create_test("parse_empty_string", test_parse_empty_string);
	su_add_test(group, parse_empty_string);

	smb_ut_test *parse_whitespace_string = su_create_test(
	        "parse_whitespace_string", test_parse_whitespace_string);
	su_add_test(group, parse_whitespace_string);

	smb_ut_test *parse_invalid_true =
	        su_create_test("parse_invalid_true", test_parse_invalid_true);
	su_add_test(group, parse_invalid_true);

	smb_ut_test *parse_invalid_false =
	        su_create_test("parse_invalid_false", test_parse_invalid_false);
	su_add_test(group, parse_invalid_false);

	smb_ut_test *parse_invalid_null =
	        su_create_test("parse_invalid_null", test_parse_invalid_null);
